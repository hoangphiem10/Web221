...
if (isset($_POST['submit'])) {
    ...
    if (($data["userModal"]->con)->query($user)) {
        echo "<script type='text/javascript'>
            ...
            window.location.href = 'http://localhost:8080/web221/user/sign_in';
        </script>";
    } else {
        echo "<script type='text/javascript'>
...
<div class="signup-form">
    <form name="signup" class="form-style" method="POST" action="">
        <div class="form-logo">
            <a href="http://localhost:8080/web221/user/sign_in">
        ...
        <div class="footer-wrapper">
            ...
            <a href="http://localhost:8080/web221/user/sign_in" class="forgotPass">
                Đăng nhập
            </a>
        </div>
    </form>
