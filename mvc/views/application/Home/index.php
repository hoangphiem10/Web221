                        ...
                        <ul class="uk-slideshow-items">
                            <li>
                                <div
                                    ...
                                    <img src="https://www.bigbasketco.com/wp-content/uploads/good-l-corp-what-americas-best-grocery-stores-have-in-common.jpg"
                                        alt="slider-1" data-uk-cover>
                                </div>
                            </li>
                            <li>
                                <div
                                    class="uk-position-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
                                    <img src="https://cdn.vox-cdn.com/thumbor/mucReJQOd2xpS_bL-4YmLwqizcU=/0x0:5568x3712/1200x800/filters:focal(2339x1411:3229x2301)/cdn.vox-cdn.com/uploads/chorus_image/image/69555166/GettyImages_1312472686t.0.jpg"
                                        alt="slider-2" data-uk-cover>
                                </div>
                            </li>
                            <li>
                                <div
                                    class="uk-position-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
                                    <img src="https://media.timeout.com/images/105041644/image.jpg" alt="slider-3"
                                        data-uk-cover>
                                </div>
                            </li>
                        </ul>
                                        ...
                                        <div class="product-item__not-active">
                                            <div class="product-item__media">
                                                <div class="uk-inline-clip uk-transition-toggle uk-light"
                                                    data-uk-lightbox="data-uk-lightbox"><img class="product-zoom"
            ...
            <div class="uk-section uk-container">
                <div class="uk-grid uk-child-width-1-2@m uk-flex-middle" data-uk-grid>
                    <div class="uk-text-center"><img
                            src="https://www.eatthis.com/wp-content/uploads/sites/4/2019/05/woman-shopping-in-produce-section.jpg?quality=82&strip=1"
                            alt="about us"></div>
                    <div>
                        ...
                        <div class="section-content">
                            <p>FreshGro là một dự án web nhằm cung cấp các sản phẩm nông sản như rau củ, trái cây
                                tươi từ các vùng miền ở Việt Nam. Dự án nằm trong khuôn khổ bài tập lớn môn Lập trình
                                web học kì 212.
                            </p>
                            <p> Nhóm gồm có 4 thành viên: Trần Phạm Thái Hòa, Nguyễn Trung Phong, Trần Nguyên Lâm, Phan
                                Thanh Hoan.</p>
                            <div class="uk-margin-medium-top"><a class="uk-button"
                                    href="http://localhost/web212/Home/catalog"><span>Xem các sản phẩm</span></a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-grid uk-child-width-1-3@s" data-uk-grid>
                    <div>
                        <div class="feature-item">
                            ...
                            <div class="feature-item__desc">Mua hàng trên website hoặc đặt hàng chỉ bằng 1 cuộc điện
                                thoại</div>
                        </div>
                    </div>
                    <div>
                        <div class="feature-item">
                            ...
                            <div class="feature-item__desc">Nông sản đạt được các chứng nhận bởi VietGAP, Global GAP về
                                độ an toàn</div>
                        </div>
                    </div>
                    <div>
                        <div class="feature-item">
                            ...
                            <div class="feature-item__desc">Đa dạng có loại hàng thực phẩm, dễ lựu chọn từ trái cây, rau
                                củ đến thịt cá</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-grid uk-child-width-1-2@m uk-flex-middle" data-uk-grid>
                    <div>
                        ...
                        <div class="section-content">
                            ...
                            <div class="uk-margin-medium-top"><a class="uk-button"
                                    href="http://localhost/web212/News/blog/1"><span>Xem tin tức</span></a></div>
                        </div>

                    </div>

                    <div class="uk-text-center"><img
                            src="https://c4.wallpaperflare.com/wallpaper/975/936/987/red-green-a-bunch-a-lot-wallpaper-preview.jpg"
                            alt="about us">
                    </div>
                </div>
            ...
            <div class="uk-container">
                ...
                <div class="uk-grid uk-child-width-1-3@s" data-uk-grid style="text-align: center;">
                    <div>
                        ...
                        <div style="margin-top: 10px;">"Nông sản sạch online yên tâm về chất lượng. Có nhiều chương
                            trình khuyến mãi, giá tốt."</div>
                    </div>
                    <div>
                        ...
                        <h5 style="margin-bottom: 0%; margin-top: 10px;">Chị Nguyễn Thị B</h5>
                        <em style="color: #56B280">25 tuổi, đến từ Hà Nội</em>
                        </figure>
                        <div style="margin-top: 10px;">"Chất lượng sản phẩm tốt, giá cả phải chăng, đặt hàng nhạnh gọn
                            lẹ."</div>
                    </div>
                    <div>
                        <img src="../../../web212/public/assets/img/pages/home/fp2.png" alt="">
                        ...
                        <div style="margin-top: 10px;">"Đặt hàng trên website rất tiện lợi, giao hàng rất nhanh chóng"
                        </div>
                    </div>
                </div>
                <br> <br><br> <br>
