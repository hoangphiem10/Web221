                                        ...
                                        <header class="uk-comment-header">
                                            <div class="uk-grid-small uk-grid-divider" data-uk-grid>
                                                <div class="uk-width-auto@s"><img class="uk-comment-avatar"
                                                        src="../../../web212/public/assets/img/pages/home/fp1.png" alt>
                                                </div>
                                ...
                                <li>
                                    <article class="uk-comment">
                                        <header class="uk-comment-header">
                                            <div class="uk-grid-small uk-grid-divider" data-uk-grid>
                                                <div class="uk-width-auto@s"><img class="uk-comment-avatar"
                                                        src="../../../web212/public/assets/img/pages/home/fp2.png" alt>
                                                </div>
                                                <div class="uk-width-expand@s">
                                                    <div class="uk-flex uk-flex-middle uk-margin-small-bottom">
                                    ...
                                    <form action="#!" method="POST">
                                        <div class="uk-grid uk-grid-small uk-child-width-1-2@s" data-uk-grid>
                                            ...
                                            <div class="uk-width-1-1"><textarea class="uk-textarea uk-form-large"
                                                    name="feedback" placeholder="Đánh giá *"></textarea></div>
                                            <div><button class="uk-button uk-button-large" name='submit'
                                                    type="submit">Gửi đánh giá</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
