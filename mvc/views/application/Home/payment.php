...
<script>
    ...
    function getOrder(){
      ...
      btn.href = 'http://localhost:8080/web221/Home/success/'+orderID+"/" +userID+"/" +datetime+"/" +price+"/" +name+"/"+email+"/" +phone+"/"+address;
    ...
    paypal.Buttons({
        ...
        onApprove: function (data, actions){
            return actions.order.capture().then(function(orderData){
                ...
                window.location.href = 'http://localhost:8080/web221/Home/success/'+orderID+"/" +userID+"/" +datetime+"/" +price+"/" +name+"/"+email+"/" +phone+"/"+address;
            });
        },
