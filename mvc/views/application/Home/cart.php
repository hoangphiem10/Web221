...
<?php
  if(!isset($_SESSION["id"])){
    ...
    window.location.href = "http://localhost/web221/user/sign_in"</script>';
  }
?>
<style>
            ...
            <div class="first-screen__box page-info">
                ...
                <div class="first-screen__breadcrumb">
                    <ul class="uk-breadcrumb">
                        ...
                        <li> <a href="http://localhost/web221/home/cart">Giỏ hàng</a></li>
                    </ul>
                </div>
                </div>
            </div>
...
let selectedItem = {
        ...
        if (text=="Đặt hàng"){
            ...
            if ((name == "" || email =="" || phone =="" || address=="" || !checkRadio)){
                ...
                if (confirm("Bạn muốn đặt đơn hàng này ?")) {
                    ...
                    btn.href = "http://localhost/web221/home/success/"+orderID+"/" +userID+"/" +datetime+"/" +totalPrice+"/" +name+"/"+email+"/" +phone+"/"+address;
    ...
    function ChangeUI(){
        ...
        if (productNumber > 0){
            ...
            // btn.href = 'http://localhost/web221/Home/payment/';
            ...
            var btn = document.getElementById('page-cart__control-btn');
            btn.href = 'http://localhost/web221/Home/catalog';
