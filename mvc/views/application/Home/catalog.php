                        ...
                        <div class="catalog-filter-row">
                            <ul class="uk-subnav">
                                ...
                                <li <?php if($_SESSION['category_id'] == 1) echo "class='uk-active'"?>
                                    data-uk-filter-control="[data-tags='1']"><a
                                        onclick="document.getElementById('category-page').innerHTML = ': Trái cây'"
                                        href="#">Trái cây</a></li>
                                <li <?php if($_SESSION['category_id'] == 2) echo "class='uk-active'"?>
                                    data-uk-filter-control="[data-tags='2']"><a
                                        onclick="document.getElementById('category-page').innerHTML = ': Thịt'"
                                        href="#">Thịt</a></li>
                                <li <?php if($_SESSION['category_id'] == 3) echo "class='uk-active'"?>
                                    data-uk-filter-control="[data-tags='3']"><a
                                        onclick="document.getElementById('category-page').innerHTML = ': Rau củ quả'"
                                        href="#">Rau củ quả</a></li>
                                <li <?php if($_SESSION['category_id'] == 4) echo "class='uk-active'"?>
                                    data-uk-filter-control="[data-tags='4']"><a
                                        onclick="document.getElementById('category-page').innerHTML = ': Thủy hải sản'"
                                        href="#">Thủy hải sản</a></li>
