    ...
    <div class="col-sm mb-2 mb-sm-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-no-gutter">
          <li class="breadcrumb-item"><a class="breadcrumb-link" href="http://localhost/web221/Order/index"></a></li>
          <!-- icon home -->
    ...
    <table class="table table-borderless card-table">
      ...
      ?>
        <tr>
          ...
          <td><a href="http://localhost/web221/Order/edit/<?php echo $row["order_id"] ?>">Edit</td>
          <td><a href="http://localhost/web221/Order/delete/<?php echo $row["order_id"] ?>">Delete</td> -->
        </tr>
      <?php 
        }
      ?>
